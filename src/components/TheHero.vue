<template>
  <main class="ii">
    <!-- herox -->
    <section class="x">
      <div class="w _ sy ni hj og ow oz m ts" aria-hidden="true"></div>
      <div class="rw tf up hd">
        <div class="uq di ds">
          <!-- content  -->
          <div class="x rj tf ph aa dh">
            <div class="pl">
              <h1 class="h1 fs ns" data-aos="fade-up" data-aos-delay="100">
                Trade your giftcards and cryptocurrencies in exchange for
                <span class="x rn ib ix">
                  <svg
                    class="w ts"
                    width="246"
                    height="76"
